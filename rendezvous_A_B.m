function [A,B] = rendezvous_A_B(model, X_bar, U_bar)

X_next = forward_euler_rend(0,X_bar,U_bar,model);
...
for i = 1:1:n
    ...
    Y(:,i) = [del_x(:,i);del_u(:,i)];
    del_x_next_p(:,i) = ...
        forward_euler_rend(0,X_bar+del_x(:,i), U_bar+del_u(:,i),model) - X_next;
    del_x_next_m(:,i) = ...
        forward_euler_rend(0,X_bar-del_x(:,i), U_bar-del_u(:,i),model) - X_next;
